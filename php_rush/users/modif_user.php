...
include_once 'modif_user_bdd.php'; 
	$id=$_COOKIE['id'];							
	$affAll = "SELECT * FROM users where id=$id;" ;
                  ...
                  <div class="myform form ">
                     ...
                     <form method="post" action="modif_user.php">
                        ...
                        <div class="form-group">
                           ...
                           <input type="password" name="password_1"  class="form-control" id="password_1" aria-describedby="emailHelp" placeholder="Leave empty if you do not want to change your password">
                        </div>
                        <div class="form-group">
                           <label for="exampleInputPassword2">Password confirmation</label>
                           <input type="password" name="password_2" id="password_2"  class="form-control" aria-describedby="emailHelp" placeholder="Leave empty if you do not want to change your password">
                        </div>
