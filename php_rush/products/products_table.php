            ...
            <table class="table table-hover">
                ...
                <tbody>
					...
					try {
							...
							$affAll = "SELECT * FROM products;" ;
							$resultat1 = $connexion->query($affAll);
							if($resultat1==false){?>
								<td colspan="4" class="text-center">No productss in Database </td>
							<?php
							}
							else {
								...
								while ($ligne = $resultat1->fetch(PDO::FETCH_ASSOC)) {?>
										<tr>
											...
											<td class="col-sm-1 col-md-1 text-center"><strong><?php echo $ligne["price"]."€"; ?></strong></td>
											<td class="col-sm-1 col-md-1 text-center"><strong><?php echo $ligne["category_id"]; ?></strong></td>
											<td class="text-center"> 
												<button type="button" class="btn btn-default btn-sm" onclick="modifProduct(<?php echo $ligne["id"]; ?>);">
													<span class="glyphicon glyphicon-edit mod2">Modify</span> 
												</button>
											</td>
											<td class="col-sm-1 col-md-1">
											<button type="button" class="btn btn-danger"
											 onclick="showModalProd(<?php echo $ligne[id]; ?>, '<?php echo $ligne["name"]; ?>');">
