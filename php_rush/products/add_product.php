<?php include('add_product_bdd.php') ?>
                  ...
                  <div class="myform form ">
                     ...
                     <form method="post" action="add_product.php">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text"  name="name" class="form-control" id="productname" aria-describedby="emailHelp" placeholder="Enter the product name">
                        </div>
                        <!--div class="form-group">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" name="price"  class="form-control" id="price" aria-describedby="emailHelp" placeholder="Enter the price in euros">
                        </div>
                        <div class="form-group">
                           <label for="exampleInputPassword2">Category</label>
                           <input type="text" name="category" id="category"  class="form-control" aria-describedby="emailHelp" placeholder="In which Category">
                        </div>
